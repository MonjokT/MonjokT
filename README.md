...
* AutoCAD, Civil 3D, ProtaStructure, Hec-Ras, Structural Design, Analysis, and Detailing

#### **Data Architecture & Analytics (Hands-on)**
* Python, SQL (SSMS), Power BI, MS Excel, Tableau
* **ML Libraries:** Pandas, NumPy, Seaborn, Matplotlib, Scikit-learn, XGBoost

#### **AI & Emerging Technologies (Theoretical Exploration & Active Study)**
* Machine Learning & Data Science Foundations
* Deep Learning & Neural Network Frameworks
* Natural Language Processing (NLP) & Computer Vision (CV)
* Robotic Process Automation (RPA) & Smart Infrastructure

#### **Operational Qualities**
* Environmental, Social, and Governance (ESG) Frameworks (GRI, SASB, IFRS), Risk Assessment, Teamwork & Coordination, AI Literacy, Health, Safety, and Environment (HSE)
...
* **Sustainability Consulting Simulation** – Tata Consultancy Services
* **Professional Affiliations:** Graduate Member, Nigerian Society of Engineers (GMNSE) | Nigerian Institution of Civil Engineers (NICE)
...
* **German:** Limited Working Proficiency (Three years of formal study)
* **Japanese:** Elementary Proficiency (Active pursuit)

---

### 🎨 Personal Pursuits

Beyond my technical commitments, I am a practitioner of the fine arts, specifically **Painting** and **Sketching**, which inform my spatial awareness. I find further balance through **Cooking**—which I treat as a study in precision—and an extensive habit of **Reading** across various disciplines.
